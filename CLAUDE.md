...
### 2026-08-26 15:20 Asia/Taipei（最新）— 修正「最新案件列表」最後一列被裁掉看不到；問題回報彈窗改成列表在上、欄位在下並修正圓角
...
### 2026-08-26 14:05 Asia/Taipei（次新）— 修正簽名檔貼上仍然跑版（table/td 全站樣式沒排除到）、範本框與簽名檔框圓角不對齊
