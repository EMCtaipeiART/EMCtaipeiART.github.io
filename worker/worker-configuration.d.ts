/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e6c14e7d2af4c0ce0ff9f0a8d487365a)
// Runtime types generated with workerd@1.20260804.1 2026-08-11 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "production";
	ALLOWED_ORIGINS: "https://emctaipeiart.github.io,http://127.0.0.1:8787,http://localhost:8787";
	GITHUB_OWNER: "EMCtaipeiART";
	GITHUB_REPO: "EMCtaipeiART.github.io";
	GITHUB_BRANCH: "main";
	GITHUB_DATABASE_PATH: "backend/data/db.json";
	GOOGLE_OAUTH_CLIENT_ID: "501170620928-dh3e431763b4ah8crq7kirmsu8m17bdj.apps.googleusercontent.com";
	ERP_BASE_URL: "https://manage.emctaipei.com";
	ERP_CLIENT_ID: "oauth_n3gUqm5r84Mu";
	ERP_REDIRECT_URI: "https://emctaipeiart.github.io";
	ADMIN_LOGIN_ACCOUNTS: "machi.chen@emctaipei.com";
	SESSION_TTL_SECONDS: "2592000";
	UPLOAD_APPS_SCRIPT_URL: "https://script.google.com/macros/s/AKfycbzgK-0G-MQ1xk3veoI19aFWgkRA6jvsMvFa2TPC8jax9sDf5GUCXUT9h-iqwu0VZDjZ/exec";
	GITHUB_TOKEN: string;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "DatabaseCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "ALLOWED_ORIGINS" | "GITHUB_OWNER" | "GITHUB_REPO" | "GITHUB_BRANCH" | "GITHUB_DATABASE_PATH" | "GOOGLE_OAUTH_CLIENT_ID" | "ERP_BASE_URL" | "ERP_CLIENT_ID" | "ERP_REDIRECT_URI" | "ADMIN_LOGIN_ACCOUNTS" | "SESSION_TTL_SECONDS" | "UPLOAD_APPS_SCRIPT_URL" | "GITHUB_TOKEN" | "ERP_CLIENT_SECRET" | "ADMIN_LOGIN_PASSWORD" | "NAS_WATCHER_API_KEY" | "DATABASE_BACKUP_API_KEY">> {}
}
